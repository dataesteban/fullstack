...
class parametroController extends Controller
{
    ...
    public function show($id_parametro){
        ...
        $parametros = parametroModel::where("id_parametro", $id_parametro)->get();
    ...
    public function update($id_parametro, Request $request){
        ...
        if(!empty($datos)){
            $parametros = parametroModel::where('id_parametro', $id_parametro)->update($datos);
    ...
    public function store(Request $request){
        ...
        if(!empty($datos)){
            $parametros = parametroModel::insert($datos);
            return redirect("/parametro");
        }
    }

    public function destroy($id_parametro, Request $request){
        return $parametros = parametroModel::where('id_parametro', $id_parametro)->delete();
    }
    ...
    public function buscarParametro($textoParametro, Request $request){
        ...
        if($textoParametro === '-'){
            ...
            $parametros=parametroModel::where('id_parametro', 'LIKE', '%'.$textoParametro.'%')->get();
